 ...
 * @author kevinbowers
 */
public class InvertedVisualizer implements Visualizer{
    private final String name = "Inverted Visualizer";
    ...
    public void update(double timestamp, double duration, float[] magnitudes, float[] phases) {
        ...
        for (int i = 0; i < num; i++) {
            ...
            rectangles[i].setLayoutY(minRectRadius + rectangles[i].getHeight());
    ...
    public String getBackgroundColor() {
        return "-fx-background-color: #AAAAAA;";
    }
}
